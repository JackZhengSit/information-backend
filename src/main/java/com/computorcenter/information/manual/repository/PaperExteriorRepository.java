...
public interface PaperExteriorRepository extends JpaRepository<PaperExterior, Long> {
  ...
  public Page<PaperExterior> manageSearch(
      ...
      @Param("publicationTimeStart") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate publicationTimeStart,
      @Param("publicationTimeEnd") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
      ...
      @Param("publicateTimeStart") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate publicateTimeStart,
      @Param("publicateTimeEnd") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate publicateTimeEnd,
      @Param("conferenceSite") String conferenceSite,
      @Param("conferenceName") String conferenceName,
      @Param("conferenceDateStart") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate conferenceDateStart,
      @Param("conferenceDateEnd") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate conferenceDateEnd,
  ...
  @Transactional
  @Query(
      value = "update paper_exterior set file_url =:fileUrl ,file_name=:filename where id = :id",
      nativeQuery = true)
