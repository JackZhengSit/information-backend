...
public interface BriefReportExteriorRepository extends JpaRepository<BriefReportExterior, Long> {
  ...
  @Query(
      value =
          "select * from brief_report_exterior "
      ...
      nativeQuery = true)
  public Page<BriefReportExterior> manageSearch(
      Pageable p,
  ...
  @Query(
      value =
          "update brief_report_exterior set file_url =:fileUrl ,file_name=:filename where id = :id",
      nativeQuery = true)
